...
080489d4 <main>:
 ...
 8048b1e:	e8 b9 01 00 00       	call   8048cdc <phase_4>
...
08048ba4 <phase_2>:
 ...
 8048bdb:	e8 76 0a 00 00       	call   8049656 <explode_bomb>
...
08048beb <phase_3>:
 ...
 8048c0d:	c7 44 24 04 72 99 04 	movl   $0x8049972,0x4(%esp)
 8048c14:	08 
 ...
 8048c29:	e8 28 0a 00 00       	call   8049656 <explode_bomb>
 ...
 8048c3d:	8b 04 95 78 99 04 08 	mov    0x8049978(,%edx,4),%eax
 8048c44:	ff e0                	jmp    *%eax
 8048c46:	81 45 f8 08 01 00 00 	addl   $0x108,-0x8(%ebp)
 8048c4d:	81 6d f8 e5 01 00 00 	subl   $0x1e5,-0x8(%ebp)
 8048c54:	81 45 f8 9a 01 00 00 	addl   $0x19a,-0x8(%ebp)
 8048c5b:	81 6d f8 5f 03 00 00 	subl   $0x35f,-0x8(%ebp)
 8048c62:	81 45 f8 39 02 00 00 	addl   $0x239,-0x8(%ebp)
 8048c69:	81 6d f8 8e 03 00 00 	subl   $0x38e,-0x8(%ebp)
 8048c70:	81 45 f8 8e 03 00 00 	addl   $0x38e,-0x8(%ebp)
 8048c77:	81 6d f8 e3 00 00 00 	subl   $0xe3,-0x8(%ebp)
 8048c7e:	eb 05                	jmp    8048c85 <phase_3+0x9a>
 8048c80:	e8 d1 09 00 00       	call   8049656 <explode_bomb>
 ...
 8048c95:	e8 bc 09 00 00       	call   8049656 <explode_bomb>
 8048c9a:	c9                   	leave  
 8048c9b:	c3                   	ret    
...
08048c9c <func4>:
 ...
 8048ca3:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
 8048ca7:	7f 09                	jg     8048cb2 <func4+0x16>
 8048ca9:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%ebp)
 8048cb0:	eb 21                	jmp    8048cd3 <func4+0x37>
 8048cb2:	8b 45 08             	mov    0x8(%ebp),%eax
 8048cb5:	48                   	dec    %eax
 8048cb6:	89 04 24             	mov    %eax,(%esp)
 8048cb9:	e8 de ff ff ff       	call   8048c9c <func4>
 8048cbe:	89 c3                	mov    %eax,%ebx
 8048cc0:	8b 45 08             	mov    0x8(%ebp),%eax
 8048cc3:	83 e8 02             	sub    $0x2,%eax
 8048cc6:	89 04 24             	mov    %eax,(%esp)
 8048cc9:	e8 ce ff ff ff       	call   8048c9c <func4>
 8048cce:	01 c3                	add    %eax,%ebx
 8048cd0:	89 5d f8             	mov    %ebx,-0x8(%ebp)
 8048cd3:	8b 45 f8             	mov    -0x8(%ebp),%eax
 8048cd6:	83 c4 08             	add    $0x8,%esp
 8048cd9:	5b                   	pop    %ebx
 8048cda:	5d                   	pop    %ebp
 8048cdb:	c3                   	ret    
...
08048cdc <phase_4>:
 ...
 8048ce2:	8d 45 f4             	lea    -0xc(%ebp),%eax
 8048ce5:	89 44 24 08          	mov    %eax,0x8(%esp)
 8048ce9:	c7 44 24 04 98 99 04 	movl   $0x8049998,0x4(%esp)
 8048cf0:	08 
 8048cf1:	8b 45 08             	mov    0x8(%ebp),%eax
 8048cf4:	89 04 24             	mov    %eax,(%esp)
 8048cf7:	e8 6c fb ff ff       	call   8048868 <sscanf@plt>
 8048cfc:	89 45 fc             	mov    %eax,-0x4(%ebp)
 8048cff:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
 8048d03:	75 07                	jne    8048d0c <phase_4+0x30>
 8048d05:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8048d08:	85 c0                	test   %eax,%eax
 8048d0a:	7f 05                	jg     8048d11 <phase_4+0x35>
 8048d0c:	e8 45 09 00 00       	call   8049656 <explode_bomb>
 8048d11:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8048d14:	89 04 24             	mov    %eax,(%esp)
 8048d17:	e8 80 ff ff ff       	call   8048c9c <func4>
 8048d1c:	89 45 f8             	mov    %eax,-0x8(%ebp)
 8048d1f:	83 7d f8 37          	cmpl   $0x37,-0x8(%ebp)
 8048d23:	74 05                	je     8048d2a <phase_4+0x4e>
 8048d25:	e8 2c 09 00 00       	call   8049656 <explode_bomb>
 8048d2a:	c9                   	leave  
 8048d2b:	c3                   	ret    
...
08048d2c <phase_5>:
 ...
 8048d2f:	83 ec 38             	sub    $0x38,%esp
 8048d32:	8d 45 e8             	lea    -0x18(%ebp),%eax
 8048d35:	89 44 24 0c          	mov    %eax,0xc(%esp)
 8048d39:	8d 45 ec             	lea    -0x14(%ebp),%eax
 8048d3c:	89 44 24 08          	mov    %eax,0x8(%esp)
 8048d40:	c7 44 24 04 72 99 04 	movl   $0x8049972,0x4(%esp)
 8048d47:	08 
 8048d48:	8b 45 08             	mov    0x8(%ebp),%eax
 8048d4b:	89 04 24             	mov    %eax,(%esp)
 8048d4e:	e8 15 fb ff ff       	call   8048868 <sscanf@plt>
 8048d53:	89 45 fc             	mov    %eax,-0x4(%ebp)
 8048d56:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
 8048d5a:	7f 05                	jg     8048d61 <phase_5+0x35>
 8048d5c:	e8 f5 08 00 00       	call   8049656 <explode_bomb>
 8048d61:	8b 45 ec             	mov    -0x14(%ebp),%eax
 8048d64:	83 e0 0f             	and    $0xf,%eax
 8048d67:	89 45 ec             	mov    %eax,-0x14(%ebp)
 8048d6a:	8b 45 ec             	mov    -0x14(%ebp),%eax
 8048d6d:	89 45 f8             	mov    %eax,-0x8(%ebp)
 8048d70:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 8048d77:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 8048d7e:	eb 16                	jmp    8048d96 <phase_5+0x6a>
 8048d80:	ff 45 f0             	incl   -0x10(%ebp)
 8048d83:	8b 45 ec             	mov    -0x14(%ebp),%eax
 8048d86:	8b 04 85 c0 a5 04 08 	mov    0x804a5c0(,%eax,4),%eax
 8048d8d:	89 45 ec             	mov    %eax,-0x14(%ebp)
 8048d90:	8b 45 ec             	mov    -0x14(%ebp),%eax
 8048d93:	01 45 f4             	add    %eax,-0xc(%ebp)
 8048d96:	8b 45 ec             	mov    -0x14(%ebp),%eax
 8048d99:	83 f8 0f             	cmp    $0xf,%eax
 8048d9c:	75 e2                	jne    8048d80 <phase_5+0x54>
 8048d9e:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
 8048da2:	75 08                	jne    8048dac <phase_5+0x80>
 8048da4:	8b 45 e8             	mov    -0x18(%ebp),%eax
 8048da7:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 8048daa:	74 05                	je     8048db1 <phase_5+0x85>
...
08048e47 <phase_6>:
 ...
 8048e4d:	c7 45 f8 6c a6 04 08 	movl   $0x804a66c,-0x8(%ebp)
 ...
 8048e9a:	a1 6c a6 04 08       	mov    0x804a66c,%eax
...
08048f7c <sig_handler>:
 ...
 8048f82:	c7 04 24 14 9c 04 08 	movl   $0x8049c14,(%esp)
 ...
 8048f9a:	c7 04 24 4c 9c 04 08 	movl   $0x8049c4c,(%esp)
 8048fa1:	e8 72 f8 ff ff       	call   8048818 <printf@plt>
 8048fa6:	a1 80 a8 04 08       	mov    0x804a880,%eax
 ...
 8048fbf:	c7 04 24 54 9c 04 08 	movl   $0x8049c54,(%esp)
...
08048fd7 <invalid_phase>:
 ...
 8048fe4:	c7 04 24 5c 9c 04 08 	movl   $0x8049c5c,(%esp)
...
08048ffc <read_six_numbers>:
 ...
 804903d:	c7 44 24 04 6d 9c 04 	movl   $0x8049c6d,0x4(%esp)
 8049044:	08 
...
08049102 <open_clientfd>:
 ...
 804912d:	c7 04 24 7f 9c 04 08 	movl   $0x8049c7f,(%esp)
 ...
 8049159:	c7 04 24 8d 9c 04 08 	movl   $0x8049c8d,(%esp)
 ...
 80491ee:	c7 04 24 9b 9c 04 08 	movl   $0x8049c9b,(%esp)
...
08049277 <skip>:
 ...
 804927d:	8b 0d 90 a8 04 08    	mov    0x804a890,%ecx
 8049283:	a1 8c a8 04 08       	mov    0x804a88c,%eax
 ...
 8049294:	05 a0 a8 04 08       	add    $0x804a8a0,%eax
...
080492ca <read_line>:
 ...
 80492df:	8b 15 90 a8 04 08    	mov    0x804a890,%edx
 80492e5:	a1 84 a8 04 08       	mov    0x804a884,%eax
 80492ea:	39 c2                	cmp    %eax,%edx
 80492ec:	75 13                	jne    8049301 <read_line+0x37>
 80492ee:	c7 04 24 a9 9c 04 08 	movl   $0x8049ca9,(%esp)
 ...
 8049301:	c7 04 24 c7 9c 04 08 	movl   $0x8049cc7,(%esp)
 ...
 804931d:	a1 84 a8 04 08       	mov    0x804a884,%eax
 8049322:	a3 90 a8 04 08       	mov    %eax,0x804a890
 ...
 8049357:	05 a0 a8 04 08       	add    $0x804a8a0,%eax
 ...
 80493a1:	05 a0 a8 04 08       	add    $0x804a8a0,%eax
 80493a6:	c6 00 00             	movb   $0x0,(%eax)
 80493a9:	8b 0d 8c a8 04 08    	mov    0x804a88c,%ecx
 ...
 80493bb:	05 a0 a8 04 08       	add    $0x804a8a0,%eax
 80493c0:	89 c2                	mov    %eax,%edx
 80493c2:	8d 41 01             	lea    0x1(%ecx),%eax
 80493c5:	a3 8c a8 04 08       	mov    %eax,0x804a88c
...
080493d2 <send_msg>:
 ...
 80493f0:	c7 04 24 ed 9c 04 08 	movl   $0x8049ced,(%esp)
 ...
 8049419:	c7 04 24 01 9d 04 08 	movl   $0x8049d01,(%esp)
 ...
 804943f:	c7 04 24 14 9d 04 08 	movl   $0x8049d14,(%esp)
 ...
 804946d:	00 
 804946e:	c7 04 24 29 9d 04 08 	movl   $0x8049d29,(%esp)
 ...
 804950c:	08 
 804950d:	c7 44 24 04 56 9d 04 	movl   $0x8049d56,0x4(%esp)
 8049514:	08 
 ...
 8049536:	05 a0 a8 04 08       	add    $0x804a8a0,%eax
 ...
 804955f:	08 
 8049560:	c7 44 24 04 72 9d 04 	movl   $0x8049d72,0x4(%esp)
 8049567:	08 
 ...
 8049576:	a1 8c a8 04 08       	mov    0x804a88c,%eax
 ...
 804958b:	c7 44 24 10 d9 99 04 	movl   $0x80499d9,0x10(%esp)
 8049592:	08 
 8049593:	c7 44 24 0c 8e 9d 04 	movl   $0x8049d8e,0xc(%esp)
 804959a:	08 
 804959b:	c7 44 24 08 93 9d 04 	movl   $0x8049d93,0x8(%esp)
 80495a2:	08 
 80495a3:	c7 44 24 04 aa 9d 04 	movl   $0x8049daa,0x4(%esp)
 80495aa:	08 
 ...
 80495c7:	c7 04 24 b3 9d 04 08 	movl   $0x8049db3,(%esp)
 ...
 80495ee:	c7 04 24 cd 9d 04 08 	movl   $0x8049dcd,(%esp)
 ...
 8049615:	c7 04 24 e6 9d 04 08 	movl   $0x8049de6,(%esp)
 ...
 804963c:	c7 04 24 01 9e 04 08 	movl   $0x8049e01,(%esp)
...
08049656 <explode_bomb>:
 ...
 804965c:	c7 04 24 18 9e 04 08 	movl   $0x8049e18,(%esp)
 8049663:	e8 60 f1 ff ff       	call   80487c8 <puts@plt>
 8049668:	c7 04 24 21 9e 04 08 	movl   $0x8049e21,(%esp)
...
08049680 <phase_defused>:
 ...
 8049686:	a1 8c a8 04 08       	mov    0x804a88c,%eax
 804968b:	83 f8 06             	cmp    $0x6,%eax
 804968e:	75 6e                	jne    80496fe <phase_defused+0x7e>
 8049690:	b8 90 a9 04 08       	mov    $0x804a990,%eax
 ...
 80496a5:	c7 44 24 04 38 9e 04 	movl   $0x8049e38,0x4(%esp)
 80496ac:	08 
 ...
 80496be:	c7 44 24 04 3e 9e 04 	movl   $0x8049e3e,0x4(%esp)
 80496c5:	08 
 ...
 80496d5:	c7 04 24 4c 9e 04 08 	movl   $0x8049e4c,(%esp)
 80496dc:	e8 e7 f0 ff ff       	call   80487c8 <puts@plt>
 80496e1:	c7 04 24 74 9e 04 08 	movl   $0x8049e74,(%esp)
 80496e8:	e8 db f0 ff ff       	call   80487c8 <puts@plt>
 80496ed:	e8 26 f8 ff ff       	call   8048f18 <secret_phase>
 80496f2:	c7 04 24 ac 9e 04 08 	movl   $0x8049eac,(%esp)
